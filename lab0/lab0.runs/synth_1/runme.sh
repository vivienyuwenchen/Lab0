...
HD_PWD='/home/comparch/CompArch_HW/Lab0/lab0/lab0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab0_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab0_wrapper.tcl
