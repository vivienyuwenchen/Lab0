...
HD_PWD='/home/comparch/CompArch_HW/Lab0/lab0/lab0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab0_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab0_wrapper.tcl -notrace
